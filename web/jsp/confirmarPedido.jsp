...
<body>
	...
	<div class="contenedorCart">
		<div class="cartBox">
			<h1 class="title">
				Your Order <span class="destacable"> </span>
			</h1>
			...
			<%if (pedidos.size() != 0){ %>
				...
				<c:if test="${pedido.cantidad != 0}">
					<tr class="cartFila">
						...
						<td class="cartElem"><input type="radio" name="${pedido.prod.idProducto}" id="${pedido.prod.idProducto}" value="Delete"/>Delete</td>
